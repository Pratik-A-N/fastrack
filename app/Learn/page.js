    ...
    <NextUIProvider>
      <div className="">
        ...
        <div className="container3 h-auto">
          <div
            className={`brand-heading ${martel.className} text-center text-2xl py-8`}
          >
            Associated Brands
          </div>
          <div className="pb-8">
        ...
        <div className="container2 h-screen bg-white text-black flex items-center justify-center">
          <div className="flex justify-center mob-cont">
            ...
            <div className="side-content flex items-start flex-col">
              ...
              <div
                className={`subheading ${inter.className} cust-text-xl mt-5`}
              >
                Step into the world of risk-free crypto trading with our
                community mock trading app. Practice, learn, and connect with
                fellow enthusiasts.
            ...
            <div className="video-card ind">
              <div className="flex ">
                ...
                <div className="content">
                  <div className="cont-head">Signup</div>
              ...
              <div className="flex mt-4">
                ...
                <div className="content">
                  <div className="cont-head">Join Competition</div>
                  <div className="cont-body">
              ...
              <div className="flex mt-4">
                ...
                <div className="content">
                  <div className="cont-head">Trade & Build Portfolio</div>
                  <div className="cont-body">
                    Apply Strategies & prove your Trading skills to Build
                    portfolio.
                  </div>
                </div>
              </div>
